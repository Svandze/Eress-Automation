package pages.confeccion.parametrizacion.grupocostosgastos;
...
public class GrupoCostosGastosPage extends BasePage {
    ...
    public void validateCostExpenseGroupsInfo(String costExpenseGroupsCode, String CostExpenseGroupsDescription) {
        ...
        Assert.assertEquals("El valor actual del código coincide con el esperado", costExpenseGroupsCode, currentCostExpenseGroupsCode);
        Assert.assertEquals("El valor actual de la descripción coincide con el esperado", CostExpenseGroupsDescription, currentCostExpenseGroupsDescription);
    }
