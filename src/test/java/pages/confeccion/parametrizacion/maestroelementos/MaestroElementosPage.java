package pages.confeccion.parametrizacion.maestroelementos;
...
public class MaestroElementosPage extends BasePage {
    ...
    public void validateMasterElementsInfo(String masterElementsCode, String masterElementsDescription, String masterElementsGroupMovements, String masterElementsTypeMovements, String masterElementsDistance, String masterElementsTime, Boolean masterElementsCheck) {
        ...
        Assert.assertEquals("El valor actual del código del grupo de movimientos coincide con el esperado", masterElementsCode, currentMasterElementsCode);
        Assert.assertEquals("El valor actual de la descripción coincide con el esperado", masterElementsDescription, currentnMasterElementsDescription);
        Assert.assertTrue("El valor actual del grupo movimientos coincide con el esperado",currentnMasterElementsGroupMovements.contains(masterElementsGroupMovements));
        Assert.assertTrue("El valor actual del tipo movimientos coincide con el esperado", currentnMasterElementsTypeMovement.contains(masterElementsTypeMovements));
        Assert.assertEquals("El valor actual del check coincide con el esperado", currentnMasterElementsCheck, (masterElementsCheck).toString());
        Assert.assertEquals("El valor actual del código del grupo de movimientos coincide con el esperado", (masterElementsCheck).toString(), currentnMasterElementsCheck );
        Assert.assertTrue("El valor actual de la distancia coincide con el esperado", currentnMasterElementsDistance.contains(masterElementsDistance));
        Assert.assertEquals("El valor actual del tiempo de movimientos coincide con el esperado", masterElementsTime, currentnMasterElementsTime);
