package pages.confeccion.parametrizacion.maquinasoperario;
...
public class MaquinasOperarioPage extends BasePage {
    ...
    public void validateMachinesOperatorInfo(String  machinesOperatorEmployee, String  machinesOperatorMachine, String  machinesOperatorAssignment, String  machinesOperatorMachines) {
        ...
        Assert.assertTrue("El valor actual del empleado contiene el valor esperado", currentWorkshopCustomer.contains( machinesOperatorEmployee));
        Assert.assertTrue("El valor actual de la asignación del taller contiene el valor esperado", currentWorkshopMachine.contains(machinesOperatorAssignment));
        Assert.assertTrue("El valor actual de las maquinas del taller contiene el valor esperado", currentWorkshopMachines.contains(machinesOperatorMachines));
