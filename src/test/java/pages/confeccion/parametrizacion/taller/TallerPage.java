package pages.confeccion.parametrizacion.taller;
...
public class TallerPage extends BasePage {
    ...
    public void validateWorkshopInfo(String workshopCustomer, String workshopCod, String workshopDescription, String workshopOTIF, String workshopPersons, String workshopStyle, String workshopMachine, String workshopAmount) {
        ...
        Assert.assertTrue("El valor actual del cliente del taller contiene el valor esperado", currentWorkshopCustomer.contains(workshopCustomer));
        Assert.assertEquals("El valor actual del código del taller contiene el valor esperado", workshopCod, currentWorkshopCustomerCod);
        Assert.assertEquals("El valor actual de la descripción del taller  contiene el valor esperado", workshopDescription, currentWorkshopDataDescription);
        Assert.assertEquals("El valor actual del OTIF del taller contiene el valor esperado", workshopOTIF, currentWorkshopDataOTIF);
        Assert.assertEquals("El valor actual de las personas del taller contiene el valor esperado", workshopPersons, currentWorkshopDataPersons);
        Assert.assertTrue("El valor actual del estilo del taller contiene el valor esperado", currentWorkshopStyle.contains(workshopStyle));
        Assert.assertTrue("El valor actual de la maquina del taller contiene el valor esperado", currentWorkshopMachine.contains(workshopMachine));
        Assert.assertEquals("El valor actual de la cantidad del taller contiene el valor esperado", workshopAmount, currentWorkshopMachineAmount);
    }
