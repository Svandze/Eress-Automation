package pages.confeccion.parametrizacion.maestrogeneros;
...
public class MaestroGenerosPage extends BasePage {
    ...
    public void validateMasterGenresInfo(String masterGenresCode,  String masterGenresDescription) {
        ...
        Assert.assertEquals("El valor actual del código coincide con el esperado", masterGenresCode, currentMasterGenresCode);
        Assert.assertEquals("La descripción actual de d coincide con el esperado", masterGenresDescription, currentMasterGenresDescription);
    }
