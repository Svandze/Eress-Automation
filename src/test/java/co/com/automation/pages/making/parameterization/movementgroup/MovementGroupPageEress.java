package co.com.automation.pages.making.parameterization.movementgroup;
...
public class MovementGroupPageEress extends BasePageEress {
    ...
    public void validateMovementGroupInfo(String movementGroupCode, String descriptionMovementGroup) {
        ...
        assertEquals(movementGroupCode, currentMovementGroupCode, "The current code value of the movement group  matches the expected value");
        assertEquals(descriptionMovementGroup, currentDescriptionMovementGroup, "The current description value  matches the expected value");
    }
